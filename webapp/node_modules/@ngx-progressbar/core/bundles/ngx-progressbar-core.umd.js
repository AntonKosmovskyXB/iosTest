(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),exports, require('@angular/common'), require('rxjs'), require('rxjs/operators'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@ngx-progressbar/core', ['@angular/core','@angular/common','exports', '@angular/common', 'rxjs', 'rxjs/operators', '@angular/core'], factory) :
    (factory(global.ng.core,global.ng.common,(global['ngx-progressbar'] = global['ngx-progressbar'] || {}, global['ngx-progressbar'].core = {}),global.ng.common,global.rxjs,global.rxjs.operators,global.ng.core));
}(this, (function (ɵngcc0,ɵngcc1,exports,common,rxjs,operators,i0) { 
...
NgProgressModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function NgProgressModule_Factory(t) { return new (t || NgProgressModule)(); }, imports: [[common.CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgProgressModule, { declarations: [NgProgressComponent], imports: [ɵngcc1.CommonModule], exports: [NgProgressComponent] }); })();
