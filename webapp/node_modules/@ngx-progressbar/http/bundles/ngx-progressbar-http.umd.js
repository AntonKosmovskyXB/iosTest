(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@ngx-progressbar/core'),exports, require('@angular/common/http'), require('rxjs/operators'), require('@ngx-progressbar/core'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@ngx-progressbar/http', ['@angular/core','@ngx-progressbar/core','exports', '@angular/common/http', 'rxjs/operators', '@ngx-progressbar/core', '@angular/core'], factory) :
    (factory(global.ng.core,global.ngxProgressbar.core,(global['ngx-progressbar'] = global['ngx-progressbar'] || {}, global['ngx-progressbar'].http = {}),global.ng.common.http,global.rxjs.operators,global.core,global.ng.core));
}(this, (function (ɵngcc0,ɵngcc1,exports,http,operators,core,core$1) { 'use strict';
