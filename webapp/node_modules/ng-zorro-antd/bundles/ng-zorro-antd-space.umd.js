(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('ng-zorro-antd/core/config'),require('@angular/common'),exports, require('@angular/common'), require('@angular/core'), require('ng-zorro-antd/core/config'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('ng-zorro-antd/space', ['@angular/core','ng-zorro-antd/core/config','@angular/common','exports', '@angular/common', '@angular/core', 'ng-zorro-antd/core/config', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory(global.ng.core,global.ngZorroAntd.core.config,global.ng.common,(global['ng-zorro-antd'] = global['ng-zorro-antd'] || {}, global['ng-zorro-antd'].space = {}), global.ng.common, global.ng.core, global['ng-zorro-antd'].core.config, global.rxjs, global.rxjs.operators));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, common, core, config, rxjs, operators) { 
var _c0 = ["*"];
'use strict';
...
NzSpaceModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function NzSpaceModule_Factory(t) { return new (t || NzSpaceModule)(); }, imports: [[common.CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NzSpaceModule, { declarations: [NzSpaceComponent,
        NzSpaceItemComponent], imports: [ɵngcc2.CommonModule], exports: [NzSpaceComponent,
