...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('rxjs'),require('@ngrx/store'),exports, require('tslib'), require('@ngrx/store'), require('rxjs'), require('rxjs/operators'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@ngrx/effects', ['@angular/core','rxjs','@ngrx/store','exports', 'tslib', '@ngrx/store', 'rxjs', 'rxjs/operators', '@angular/core'], factory) :
    (global = global || self, factory(global.ng.core,global.rxjs,global.ngrx.store,(global.ngrx = global.ngrx || {}, global.ngrx.effects = {}), global.tslib, global.ngrx.store, global.rxjs, global.rxjs.operators, global.ng.core));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, tslib, store, rxjs, operators, core) { 'use strict';
    ...
    var Actions = /** @class */ (function (_super) {
        ...
        var Actions_1;
        Actions = Actions_1 = tslib.__decorate([ tslib.__param(0, core.Inject(store.ScannedActionsSubject)),
            tslib.__metadata("design:paramtypes", [rxjs.Observable])
        ], Actions);
Actions.ɵfac = function Actions_Factory(t) { return new (t || Actions)(ɵngcc0.ɵɵinject(store.ScannedActionsSubject)); };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Actions, [{
        type: core.Injectable
                ...
                type: core.Inject,
                args: [store.ScannedActionsSubject]
            }] }]; }, null); })();
        return Actions;
    }(rxjs.Observable));
    function ofType() {
    ...
    var EffectSources = /** @class */ (function (_super) {
        ...
        EffectSources = tslib.__decorate([ tslib.__param(1, core.Inject(EFFECTS_ERROR_HANDLER)),
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(EffectSources, [{
    ...
    var EffectsRunner = /** @class */ (function () {
        ...
        EffectsRunner = tslib.__decorate([ tslib.__metadata("design:paramtypes", [EffectSources,
                store.Store])
        ], EffectsRunner);
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(EffectsRunner, [{
    ...
    var EffectsRootModule = /** @class */ (function () {
        ...
        EffectsRootModule = tslib.__decorate([ tslib.__param(3, core.Inject(ROOT_EFFECTS)),
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(EffectsRootModule, [{
    ...
    var EffectsFeatureModule = /** @class */ (function () {
        ...
        EffectsFeatureModule = tslib.__decorate([ tslib.__param(1, core.Inject(FEATURE_EFFECTS)),
